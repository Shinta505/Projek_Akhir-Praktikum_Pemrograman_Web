...
<body style="background-color: #FEF9EF; color: #213555;">
    ...
    <div class="row">
        <div class="col-8">
            <form class="mx-3" action="input_janji2.php" method="POST">
                <!-- //nama ortu, nama anak  -->
                ...
                <select name="dokter" id="dokter" class="py-1 ms-4 bg-transparent" size="2" style="width: 39%; background-color: #A2D2FF;" required>
                    <?php
                    ...
                    ?>
                        <option value="<?php echo $data['dokterID']; ?>"><?php echo $data['nama'] . " - " . $data['lokasi']; ?></option>
                    <?php } ?>
                </select>
                <br>
