  ...
  <center>
    <div class="row">
      ...
      <div class="col-5" style="background-color: #FEF9EF; height: 40rem;">
        <nav class="navbar">
          <a class="navbar-brand fw-semibold" href="#"></a>
          <a class="nav-link fs-5 mx-3 mt-2" style="color : #213555;" href="login_admin.php"><button class="btn mt-1 py-2 px-2 fw-semibold text-center" style="background-color : #FEE440; font-size: 16px; width: 80px;"> Admin </button>
          </a>
        </nav>
        ...
        <h1 class="mt-3 fw-bold">Welcome Back!</h1>
        ...
        <form action="check_status.php" method="POST" class="m-5 p-5 pt-2 mt-0 mb-4">
          <div class="row mb-3">
            <label for="inputEmail3" class="col-sm-2 fw-medium col-form-label mt-2">Email</label>
            <input type="email" class="bg-transparent py-1" style="border: none; border-bottom: 2px solid #A2D2FF;" id="inputEmail3" name="email" required>
          </div>
          <div class="row mb-3">
            <label for="inputPassword3" class="col-sm-2 fw-medium col-form-label">Password</label>
            <input type="password" class="bg-transparent py-1" id="inputPassword3" style="border: none; border-bottom: 2px solid #A2D2FF;" name="password" required>
          </div>
        ...
        <h6 class="fw-light">Don't have an account? <a href="index_regis.php" class="text-decoration-none fw-medium"> Sign Up</a></h6>
      </div>
    </div>
