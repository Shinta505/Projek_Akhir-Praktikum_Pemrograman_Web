...
<body style="background-color : #FEF9EF; color : #213555">
  <ul class="nav justify-content-between bg-transparent mt-3 mb-3" style="margin-left: 19rem; margin-right: 2rem;">
    <li class="nav-item">
      <h1 class="fs-1 fw-bold">Jadwal Kunjungan Pasien</h1>
    </li>
    <li class="nav-item">
    ...
    <div class="col-8 m-5 mt-3">
      <table class="table table-striped table-primary">
        ...
        $query = mysqli_query($connect, "SELECT k.pasienID, k.parent_name, k.children_name, k.troubling_symptoms, k.addictional_information, k.children_age, k.visit_date, k.kunjunganID, d.nama, d.lokasi FROM kunjungan k 
                                   INNER JOIN dokter d ON k.dokterID = d.dokterID WHERE k.status = 0 ORDER BY pasienID ASC");
        ...
        ?>
          <tr>
            ...
            <td><a href="selesai.php?kunjunganID=<?php echo $data['kunjunganID']; ?>"> <button class="btn mt-1 py-0 fw-semibold text-center" style="background-color : #FEE440; font-size: 16px; width: 80px;"> Selesai</button></a></td>
          </tr>
        <?php
        }
        ?>
