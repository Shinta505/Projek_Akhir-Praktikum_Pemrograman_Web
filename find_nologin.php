...
<body>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item mt-1 pt-1">
                                ...
                                <a href="login.php">
                                    <button class="btn px-4 rounded-pill fw-semibold fs-5" style="background-color : #FEE440;  width: 360px;" type="submit" data-bs-toggle="modal" data-bs-target="#exampleModal" value="login">Login Pasien</button>
                                </a> <br> <br>
                                <a href="login_admin.php">
                                    <button class="btn px-4 rounded-pill fw-semibold fs-5" style="background-color : #FEE440;  width: 360px;" type="submit" data-bs-toggle="modal" data-bs-target="#exampleModal" value="login">Login Admin</button>
                                </a>
                            </li>
                    </div>
                </center>
    ...
    <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="card border border-2 shadow p-3 mb-5 bg-body-info">
                            ...
                            <div class="card-body mx-3">
                                ...
                                <a href="make_appoinment.php" class="btn py-3 mb-3 text-center" style="width: 100%;">
        ...
        <div class="col-3 mt-5">
            <form action="select_nologin.php" method="POST">
            ...
            <img src="doctor.png" alt="" style="width: 100%; margin-top: 3rem;">
        </div>
    </div>
