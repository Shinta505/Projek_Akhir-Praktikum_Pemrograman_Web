...
<body style="background-color: #FEF9EF; color: #213555;">
    ...
    <ul class="nav justify-content-between bg-transparent mt-3 mb-3" style="margin-left: 11rem; margin-right: 2rem;">
        <li class="nav-item">
            <h1 class="fs-1 fw-bold">Edit Dokter</h1>
        </li>
        <li class="nav-item">
    ...
    $query = mysqli_query($connect, "SELECT * FROM dokter WHERE dokterID='$dokterID'");
    $data = mysqli_fetch_array($query);
    ?>
    <div class="row">
        <div class="col-8">
            <form class="mx-3" action="proses_edit_doctor.php" method="POST">
                <input type="hidden" name="dokterID" value="<?php echo $data['dokterID'] ?>">
                <!-- Nama Dokter  -->
                <label class="ms-5 mt-4" for="nama">Nama Lengkap</label>
                <input class="fw-light ms-5 bg-transparent py-1" type="text" name="nama" style="border: none; border-bottom: 1px solid #A2D2FF; padding-right: 15rem;" value="<?php echo $data['nama'] ?>" required>
                <br>
                <!-- Spesialis  -->
                <label class="ms-5 pe-5 mt-4" for="kualifikasi">Spesialis</label>
                <input class="fw-light ms-5 bg-transparent py-1" type="text" name="kualifikasi" style="border: none; border-bottom: 1px solid #A2D2FF; " value="<?php echo $data['kualifikasi'] ?>" required>
                <br>
                <!-- Lokasi Dokter  -->
                ...
                <input class="fw-light ms-5 bg-transparent py-1" type="text" name="biaya" style="border: none; border-bottom: 1px solid #A2D2FF; " value="<?php echo $data['biaya'] ?>" required>
                <br>
                <!-- Link Foto  -->
                <label class="ms-5 pe-5 mt-4" for="foto">Foto Dokter</label>
                <input class="fw-light bg-transparent py-1" type="text" name="foto" style="border: none; border-bottom: 1px solid #A2D2FF; " value="<?php echo $data['foto'] ?>" required>
                <br>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Klik selesai untuk mengkonfirmasi Perubahan ini.
                            </div>
