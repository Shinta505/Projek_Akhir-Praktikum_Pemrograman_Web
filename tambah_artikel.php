...
<body style="background-color: #FEF9EF; color: #213555;">
    ...
    <ul class="nav justify-content-between bg-transparent mt-3 mb-3" style="margin-left: 11rem; margin-right: 2rem;">
        <li class="nav-item">
            <h1 class="fs-1 fw-bold">Tambah Artikel</h1>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
        <div class="col-8">
            <form class="mx-3" action="input_artikel.php" method="POST">
                <!-- Judul Artikel  -->
                <label class="ms-5 mt-4" for="Judul">Judul Artikel</label>
                <input class="fw-light ms-5 bg-transparent py-1" type="text" name="Judul" style="border: none; border-bottom: 1px solid #A2D2FF; padding-right: 15rem;" required>
                <br>
                <!-- Keterangan Artikel  -->
                <label class="ms-5  mt-4" for="Keterangan">Keterangan Artikel</label>
                <textarea cols="20" rows="5" class="fw-light ms-3 bg-transparent py-1" type="text" name="Keterangan" style="border: none; border-bottom: 1px solid #A2D2FF; padding-right: 15rem;" required></textarea>
                <br>
                <!-- Link Artikel  -->
                <label class="ms-5 pe-5 mt-4" for="Selengkapnya">Link Artikel</label>
                <input class="fw-light ms-5 bg-transparent py-1" type="text" name="Selengkapnya" style="border: none; border-bottom: 1px solid #A2D2FF; " required>
                <br>
                <!-- Gambar Artikel  -->
                <label class="ms-5 pe-5 mt-4" for="Gambar">Link Gambar Artikel</label>
                <input class="fw-light bg-transparent py-1" type="text" name="Gambar" style="border: none; border-bottom: 1px solid #A2D2FF; " required>
                <br>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Klik selesai untuk mengkonfirmasi Artikel ini.
                            </div>
